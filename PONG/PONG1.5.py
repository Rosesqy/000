...
while keepGoing:
    ...
    if bally+ballRad*2>=pady and bally+ballRad*2<=pady+padh and speedY>0: ##difficult
        if ballx+ballRad >=padx and ballx+ballRad <=padx+padw:
            speedY=-speedY
            points+=1
            bouncecounter+=1
            hitPadSound.play()
...
##    pygame.draw.rect(screen,WHITE,(padx,pady,padw,padh))
    padPic=pygame.transform.scale(padPic,((padx,pady,padw,padh)))
